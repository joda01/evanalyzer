 ...
 */
public class EDMThreadSafe implements ExtendedPlugInFilter {
    ...
    private MaximumFinderThreadSafe maxFinder = new MaximumFinderThreadSafe();    //we use only one MaximumFinder (nice progress bar)
    ...
    public void run (ImageProcessor ip) {
        ...
        if (USES_MAX_FINDER[processType]) {
            ...
            int maxOutputType = USES_WATERSHED[processType] ? MaximumFinderThreadSafe.SEGMENTED : MaximumFinderThreadSafe.SINGLE_POINTS;
    ...
    public void toWatershed (ImageProcessor ip) {
        ...
        ByteProcessor maxIp = maxFinder.findMaxima(floatEdm, MAXFINDER_TOLERANCE,
                ImageProcessor.NO_THRESHOLD, MaximumFinderThreadSafe.SEGMENTED, false, true);
