...
public class MaximumFinderThreadSafe implements ExtendedPlugInFilter, DialogListener {
    //filter params
    ...
    private  int dialogOutputType = POINT_SELECTION;
    /** output type names */
    ...
    private  boolean useMinThreshold;
    ...
    */
    public  int[] findMaxima(double[] xx, double tolerance, int edgeMode ) {
    ...
    public  int[] findMaxima(double[] xx, double tolerance, boolean excludeOnEdges) {
    ...
    */
    public  int[] findMinima(double[] xx, double tolerance, boolean excludeEdges ) {
        int edgeMode = (excludeEdges) ? 1 : 0;  
        return findMinima(xx, tolerance, edgeMode);
    }
        
    public  int[] findMinima(double[] xx, double tolerance, int edgeMode) {
        int len = xx.length;
