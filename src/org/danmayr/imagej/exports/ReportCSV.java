...
public class ReportCSV extends ReportGenerator {
    ...
    public ReportCSV(String outputFolder, String reportFileName, AnalyseSettings settings) {
    ...
    private void AppendLine(String line) {
        try {
            FileWriter fw = new FileWriter(this.getFileName(), true); // the true will append the new data
